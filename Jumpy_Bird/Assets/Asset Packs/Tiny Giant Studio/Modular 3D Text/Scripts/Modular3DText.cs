...
namespace MText
{
    ...
    public class Modular3DText : MonoBehaviour
    {
        ...
        [SerializeField] private float _characterSpacingInput = 1;
        public float CharacterSpacingInput
        {
            get { return _characterSpacingInput; }
            set { _characterSpacingInput = value; SetTextDirty(); }
        }
        ...
        [SerializeField] private float _lineSpacingInput = 1;
        public float LineSpacingInput
        {
            get { return _lineSpacingInput; }
            set { _lineSpacingInput = value; SetTextDirty(); }
        }
        ...
        float StartingX(string myString)
        {
            ...
            {
                if (!Font.monoSpaceFont)
                    return ((adjustedWidth / 2) - (TotalSpacingRequiredFor(myString) - (CharacterSpacing * Font.emptySpaceSpacing))) * textDirection;
                //return ((adjustedLength / 2) - (TotalSpacingRequiredFor(myString) - (characterSpacing))) * textDirection;
                else
                    return ((adjustedWidth / 2) - (myString.Length * CharacterSpacing)) * textDirection;
            }
        }
        ...
        {
            return Mathf.FloorToInt(adjustedWidth / CharacterSpacing);
        }
